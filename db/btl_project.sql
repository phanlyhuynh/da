...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 16, 2017 lúc 03:59 PM
...
CREATE TABLE `tbl_product` (
  ...
  `c_up` int(11) NOT NULL DEFAULT '1',
  `c_down` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_product` (`pk_product_id`, `fk_category_product_id`, `c_name`, `c_description`, `c_content`, `c_img`, `c_price`, `c_hotproduct`, `c_up`, `c_down`) VALUES
(0, 1, 'Iphone 8', '<p>iphone 10 mới ra mắt</p>\r\n', '<p>iPhone X, iPhone 8 v&agrave; 8 Plus được giới thiệu c&ugrave;ng l&uacute;c nhưng bộ đ&ocirc;i iPhone 8 được giao đến người d&ugrave;ng chỉ 10 ng&agrave;y sau đ&oacute;, c&ograve;n iPhone X th&igrave; dời đến tận ng&agrave;y 3/11. Điều n&agrave;y đ&atilde; l&agrave;m nhiều người d&ugrave;ng kh&ocirc;ng thể chờ đợi được l&acirc;u v&agrave; đi mua iPhone 8 lẫn 8 Plus.</p>\r\n\r\n<p>Kết quả: Sau 1 tuần mở b&aacute;n iPhone 8 v&agrave; 8 Plus đ&atilde; chiếm được 0.7% so với tổng số iPhone đang được sử dụng tr&ecirc;n to&agrave;n cầu. So với bộ đ&ocirc;i iPhone 7 / 7 Plus (1.2%) th&igrave; kh&ocirc;ng thua k&eacute;m qu&aacute; nhiều. Chi&ecirc;u b&agrave;i dời ng&agrave;y iPhone X để tạo sức mua cho bộ đ&ocirc;i iPhone 8 v&agrave; 8 Plus đ&atilde; th&agrave;nh c&ocirc;ng.</p>\r\n', '15108426021.jpg', 0, 1, 1, 1),
(1, 1, 'SamSung note8', '<p>Samsung Galaxy Note 8 trang bị m&agrave;n h&igrave;nh v&ocirc; cực 6.3 inch, vi xử l&yacute; mạnh mẽ, bộ nhớ RAM l&ecirc;n đến 6 GB c&ugrave;ng c&ocirc;ng nghệ kh&aacute;ng nước IP68, m&aacute;y trang bị nhiều c&ocirc;ng</p>\r\n', '<p>Samsung Galaxy Note 8 trang bị m&agrave;n h&igrave;nh v&ocirc; cực 6.3 inch, vi xử l&yacute; mạnh mẽ, bộ nhớ RAM l&ecirc;n đến 6 GB c&ugrave;ng c&ocirc;ng nghệ kh&aacute;ng nước IP68, m&aacute;y trang bị nhiều c&ocirc;ngSamsung Galaxy Note 8 trang bị m&agrave;n h&igrave;nh v&ocirc; cực 6.3 inch, vi xử l&yacute; mạnh mẽ, bộ nhớ RAM l&ecirc;n đến 6 GB c&ugrave;ng c&ocirc;ng nghệ kh&aacute;ng nước IP68, m&aacute;y trang bị nhiều c&ocirc;ngSamsung Galaxy Note 8 trang bị m&agrave;n h&igrave;nh v&ocirc; cực 6.3 inch, vi xử l&yacute; mạnh mẽ, bộ nhớ RAM l&ecirc;n đến 6 GB c&ugrave;ng c&ocirc;ng nghệ kh&aacute;ng nước IP68, m&aacute;y trang bị nhiều c&ocirc;ng</p>\r\n', '15108429432.jpg', 2000000, 0, 1, 1),
(2, 1, 'iphone7', '<p>IPhone 7 - Cập nhật tin tức, h&igrave;nh ảnh ra mắt iphone7, video so s&aacute;nh điện thoại iPhone 7 với c&aacute;c si&ecirc;u phẩm kh&aacute;c. Những điểm mạnh, điểm yếu của iPhone 7 l&agrave; g&igrave;?</p>\r\n', '<p>IPhone 7 - Cập nhật tin tức, h&igrave;nh ảnh ra mắt iphone7, video so s&aacute;nh điện thoại iPhone 7 với c&aacute;c si&ecirc;u phẩm kh&aacute;c. Những điểm mạnh, điểm yếu của iPhone 7 l&agrave; g&igrave;?IPhone 7 - Cập nhật tin tức, h&igrave;nh ảnh ra mắt iphone7, video so s&aacute;nh điện thoại iPhone 7 với c&aacute;c si&ecirc;u phẩm kh&aacute;c. Những điểm mạnh, điểm yếu của iPhone 7 l&agrave; g&igrave;?</p>\r\n', '15108429283.jpg', 6000000, 0, 1, 1),
(3, 2, 'Asus K551', '<p>The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .</p>\r\n', '<p>The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .</p>\r\n', '15108433334.jpg', 15000000, 0, 1, 1),
(4, 2, 'Asus X123', '<p>The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .</p>\r\n', '<p>The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .The ASUS K551 features the latest Intel&reg; Core&trade; i7 processor and the NVIDIA&reg; GeForce&reg; GT840M graphics card. Asus K551 is the best mainstream notebook .</p>\r\n', '15108433175.jpg', 12000000, 1, 1, 1),
(5, 8, 'Sam Sung Galaxy J7', '<p>Khuyến m&atilde;i giảm gi&aacute; sốc</p>\r\n', '<p>c&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;ic&aacute;c sản phẩm khuyến m&atilde;i</p>\r\n', '15108443126.jpg', 2000000, 0, 1, 1);
...
--
-- Đang đổ dữ liệu cho bảng `tbl_support`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_support_online`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_support_online`
--
...
(6, 'test', 'ceea23519f6f86ad67e9f798bf8002cb', '@1');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_user_online`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_user_online`
--
...
--
-- Chỉ mục cho bảng `tbl_support_online`
--
...
--
ALTER TABLE `tbl_news`
  MODIFY `pk_news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `tbl_order_detail`
  MODIFY `order_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
--
...
--
-- AUTO_INCREMENT cho bảng `tbl_support_online`
--
ALTER TABLE `tbl_support_online`
...
--
ALTER TABLE `tbl_user`
  MODIFY `pk_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;COMMIT;
