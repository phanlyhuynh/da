<?php 
	class controller_order extends controller{
		public function __construct(){
			...
			$arr = $this->model->fetch("select * from tbl_order inner join tbl_customer on tbl_order.customer_id = tbl_customer.customer_id order by trangthai,order_id desc limit $from,$record_per_page");
			//load view
