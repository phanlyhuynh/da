            ...
            <?php 
             ...
             ?>
              <li class="clearfix" id="item-1853038">
                <div class="image"> <a href="index.php?controller=product_detail&id=<?php echo $value["pk_product_id"]; ?>"> <img alt="<?php echo $value["c_name"]; ?>" src="public/upload/product/<?php echo $value["c_img"]; ?>" title="<?php echo $value["c_name"]; ?>" class="img-responsive"> </a> </div>
                <div class="info">
                  <h3><a href="index.php?controller=product_detail&id=<?php echo $value["pk_product_id"]; ?>"><?php echo $value["c_name"]; ?></a></h3>
                  <p><?php echo $value["number"]; ?> x <?php echo number_format($value["c_price"]); ?>₫</p>
                </div>
                <div> <a href="index.php?controller=cart&act=delete&id=<?php echo $value["pk_product_id"]; ?>"> <i class="fa fa-times"></i></a> </div>
              </li>
              <?php } ?>
            <?php } ?>
            </ul>
...
<div class="bottom-header">
  <div class="container">
    <div class="clearfix">
      <ul class="main-nav col-md-12 hidden-xs hidden-sm list-unstyled">
